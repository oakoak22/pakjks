...
local cfg = {
    ...
    discord = "https://discord.gg/ab4eTtTg",
...
local function buildUI()
    ...
    Part2.Title.Text = "FX-HUB DDS VEHICLE SPEED SCRIPT V4"
...
local function loadScript()
    ...
    local function createBoostGui()
        ...
        boostBtn.Position = UDim2.new(1, -140, 1, -200)
        ...
        settingsBtn.Position = UDim2.new(0.5, -30, 1, -120)
...
local function main()
    ...
    -- AUTO COPY DISCORD LINK SAAT VERIFY BERHASIL
    pcall(function()
        if setclipboard then
            setclipboard("https://discord.gg/MTayUHrs")
        end
    end)

    createNotification(
        "Success!",
        "Key verified! Discord link copied to clipboard.",
        3,
